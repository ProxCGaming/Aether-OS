...
description: Emil Kowalski's philosophy on UI polish, component design, animation decisions, and craft sensibility. Only invoke this skill when the user explicitly triggers it with the command '/emil-design-eng'. Do not invoke automatically for general UI or frontend tasks.
---
